        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              // In a stricter setup, replace with a nonce-based CSP strategy.
              "script-src 'self' 'unsafe-inline'",
              "style-src 'self' 'unsafe-inline'",
              "img-src 'self' data: blob: https://storage.koralink.sa",
              // Allow requests to the NestJS backend and any sub-origin of koralink.sa
              "connect-src 'self' https://api.koralink.sa",
              "font-src 'self' data:",
              "frame-src 'none'",
              "object-src 'none'",
              "base-uri 'self'",
